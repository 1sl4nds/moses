...
const (
	...
	DataVendingMachines             int = 90 // TBD
	...
	Highlights                      int = 84 // TBD
	HTTPAuth                        int = 98 // TBD
	HTTPFileStorageIntegration      int = 96 // TBD
	...
	RecommendedApplicationHandlers  int = 89 // TBD
